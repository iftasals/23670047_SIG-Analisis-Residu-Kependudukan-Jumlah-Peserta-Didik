...
var style_pemetaanresidukependudukanpesertadidikjenjangsmp_0 = function(feature, resolution){
    ...
    var value = feature.get("jml pdidik");
    var labelText = "";
    size = 0;
    ...
    if (value > 897.000000 && value <= 2305.666667) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 3714.333333 && value <= 5123.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 2305.666667 && value <= 3714.333333) {
            style = [ new ol.style.Style({
